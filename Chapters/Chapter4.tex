...
Resultado: el ensayo se superó con éxito. En la figura \ref{fig:pruConf_9_res} se muestran las imágenes obtenidas del \textit{display} para cada paso. A partir de la misma secuencia de prueba se verificó la apertura de la tapa de seguridad una vez iniciado el ensayo, es decir, en vez de pulsar Cancelar en el paso 17 se procedió a abrir la tapa de seguridad y el resultado obtenido fue equivalente.
